                    ...
                    <div className="bg-gradient-to-br from-[#0B1F3A]/50 to-black/40 rounded-xl p-6 border border-white/10">
                      ...
                      <div className="mb-6 p-4 bg-[#bc000c]/10 border-l-4 border-[#bc000c] rounded-r-lg">
                        ...
                        <p className="text-white text-sm">
                          {loadingXAI ? 'Analyse IA en cours...' : (xaiInsight?.strategy || `Stratégie d'${xaiInsight?.recommendation?.action === 'ACHETER' ? 'achat' : xaiInsight?.recommendation?.action === 'VENDRE' ? 'vente' : 'attente'} recommandée. ${xaiInsight?.recommendation?.confidence || 80}% de confiance basé sur l'analyse LSTM.`)}
                        </p>
                      </div>
